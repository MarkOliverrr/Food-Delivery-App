...
if(isset($_POST['submit']))        
{
    ...
    else
    {
        ...
        if(!empty($_FILES['file']['name'])){
            ...
            // No new image, update all other fields only
            $sql = "UPDATE restaurant SET c_id='$_POST[c_name]', title='$res_name', email='$_POST[email]', phone='$_POST[phone]', url='$_POST[url]', o_hr='$_POST[o_hr]', c_hr='$_POST[c_hr]', o_days='$_POST[o_days]', address='$_POST[address]' WHERE rs_id='$_GET[res_upd]'";
            mysqli_query($db, $sql);
            $success = '<div class="alert alert-success alert-dismissible fade show">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <strong>Record Updated!</strong>
...
<div id="main-wrapper">
    <!-- Header & Sidebar code here (same as original) -->
