    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background-color: #f9f9f9; padding: 30px; border: 1px solid #ddd; border-top: none; border-radius: 0 0 5px 5px;">
            ...
            <div style="background-color: #fff; border: 2px dashed #5c4ac7; padding: 20px; text-align: center; margin: 20px 0; border-radius: 5px;">
                ...
                <h1 style="margin: 10px 0; font-size: 36px; letter-spacing: 8px; color: #5c4ac7; font-family: 'Courier New', monospace;">{{ $resetCode }}</h1>
            ...
            <div style="background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 20px 0; border-radius: 4px;">
                ...
                <ol style="margin: 10px 0; padding-left: 20px; color: #856404;">
                    ...
                    <li>Enter the 6-digit code above: <strong>{{ $resetCode }}</strong></li>
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="{{ $resetLink }}" style="background-color: #5c4ac7; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; display: inline-block; font-weight: bold;">Go to Reset Password Page</a>
            </div>
            
            <p style="font-size: 12px; color: #666; margin-top: 20px;">
                Or copy and paste this link in your browser:<br>
                <a href="{{ $resetLink }}" style="color: #5c4ac7; word-break: break-all;">{{ $resetLink }}</a>
            </p>
