...
<?php $__env->startSection('title', 'Home || Online Food Ordering System'); ?>

<?php $__env->startSection('content'); ?>
<section class="hero bg-image" data-image-src="<?php echo e(asset('images/img/pimg.jpg')); ?>">
            ...
            <?php $__currentLoopData = $popularDishes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dish): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                    <div class="food-item-wrap">
                        <div class="figure-wrap bg-image" data-image-src="<?php echo e(asset('admin/Res_img/dishes/' . $dish->img)); ?>"></div>
                        <div class="content">
                            <h5><a href="<?php echo e(route('dishes.show', $dish->restaurant->rs_id)); ?>"><?php echo e($dish->title); ?></a></h5>
                            <div class="product-name"><?php echo e($dish->slogan); ?></div>
                            <div class="price-btn-block">
                                <span class="price">₱<?php echo e(number_format($dish->price, 2)); ?></span>
                                <a href="<?php echo e(route('dishes.show', $dish->restaurant->rs_id)); ?>" class="btn theme-btn-dash pull-right">Order Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <nav class="primary pull-left">
                        <ul>
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="#" data-filter=".<?php echo e($category->c_name); ?>"><?php echo e($category->c_name); ?></a></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </nav>
                </div>
        ...
        <div class="row">
            <div class="restaurant-listing">
                <?php $__currentLoopData = $restaurants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $restaurant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all <?php echo e($restaurant->category->c_name ?? ''); ?>">
                        <div class="restaurant-wrap">
                            <div class="row">
                                <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                    <a class="restaurant-logo" href="<?php echo e(route('dishes.show', $restaurant->rs_id)); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Owner\Desktop\Final Project - Food delivery\resources\views/home.blade.php ENDPATH**/ ?>